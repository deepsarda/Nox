...
object OpcodeSelector {
    ...
    fun binaryOpcode(op: BinaryOp, result: TypeRef, left: TypeRef, right: TypeRef): Int {
    ...
    fun compoundAssignOpcode(op: AssignOp, targetType: TypeRef): Int = when (op) {
    ...
    fun subOpForGet(fieldType: TypeRef): Int = when {
    ...
    fun subOpForSet(valType: TypeRef): Int = when {
